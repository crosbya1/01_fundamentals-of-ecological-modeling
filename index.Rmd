...
.pull-left[
```{r poisson-random, fig.show = 'hide'}
...
.pull-right[
```{r ref.label = 'poisson-random', echo = FALSE}
plot(table(rpois(1000, 2)), lwd = 3, ylab = "Frequency", xlab = "Abundance", main = "Poisson distribution")
text(5.5, 200, expression(lambda == 2), cex = 3)
```
]
...
* The think you change is the predictor variable  
